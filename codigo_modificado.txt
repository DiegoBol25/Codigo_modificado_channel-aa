...
function handleDtmf(channel, digit) {
  if (digit === 1) {
    // Redirigir a extension 100 del contexto 'default'
    console.log('Redirigiendo a la extensión 100...');
...
channel.continueInDialplan({
  ...
  if (err) {
    ...
    console.log('Redirigido exitosamente a 100 en el contexto default');
  }
});
    ...
    channel.play({media: 'sound:option-is-invalid'}, function(err) {
      if (err) {
